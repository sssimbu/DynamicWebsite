...
@WebServlet("/Insertcocjava")
public class Insertcocjava extends HttpServlet {
...
System.out.println("excuted");
			...
			//if (picture != null) {
			 ...
			 PreparedStatement ps = con.prepareStatement("insert into coctable(name,price,image) values(?,?,?)");
			 ...
			 ps.setString(2, price);
				...
				if (i > 0) {
					response.sendRedirect("insertcocsuccessful.jsp");
					System.out.println("saved");
