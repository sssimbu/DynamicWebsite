...
@WebServlet("/Insertgarjava")
public class Insertgarjava extends HttpServlet {
...
System.out.println("excuted");
			...
			//if (picture != null) {
			 ...
			 PreparedStatement ps = con.prepareStatement("insert into gartable(name,price,image) values(?,?,?)");
			 ...
			 ps.setString(2, price);
				...
				if (i > 0) {
					response.sendRedirect("insertgarsuccessful.jsp");
					System.out.println("saved");
