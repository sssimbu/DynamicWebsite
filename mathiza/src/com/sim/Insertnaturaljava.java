...
@WebServlet("/Insertnaturaljava")
public class Insertnaturaljava extends HttpServlet {
...
System.out.println("excuted");
			...
			//if (picture != null) {
			 ...
			 PreparedStatement ps = con.prepareStatement("insert into naturaltable(name,price,image) values(?,?,?)");
			 ...
			 ps.setString(2, price);
				...
				if (i > 0) {
					response.sendRedirect("insertnaturalsuccessful.jsp");
					System.out.println("saved");
